...
const SECTIONS=[["What we collect","Your account details, pet profiles, bookings and messages with providers. Location only while a live walk is running."],["What we never collect","Card numbers never touch our servers. Payments run entirely through Stripe and Link. Face ID stays on your device."],["How we use it","To match you with nearby providers, run bookings, send the reminders you asked for and keep the community safe."],["Sharing","Providers see what they need to care for your pet: profile, health notes and your first name. We never sell personal data. Ever."],["Your rights","Export or delete everything from Profile at any time. Deletion is permanent and completes within 30 days."]];
        ...
        <div className="relative" style={{width:390,height:844,borderRadius:50,border:'8px solid #000',overflow:'hidden',backgroundColor:CREAM}}>
          ...
          <div className="absolute inset-0 overflow-y-auto" style={{background:CREAM,scrollbarWidth:'none'}}>
            <div className="pt-14 pb-5 px-5 flex items-center justify-center relative sticky top-0 z-30 pointer-events-none" style={{background:'linear-gradient(to bottom, #F7F5F2 0%, #F7F5F2 56%, rgba(247,245,242,0) 100%)'}}>
              ...
              <h1 className="text-[17px] font-bold" style={{color:INK}}>Privacy policy</h1>
            </div>
            <div className="px-4 pb-12">

              <p className="text-[11.5px] ml-1.5 mt-1" style={{color:TERT}}>Version 1.3 · February 2026</p>
              {SECTIONS.map(([h,p],i)=>(
