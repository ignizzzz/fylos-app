...
6. **Banned:** "Oops", "Uh oh", "Sorry for the inconvenience", "successfully", "users", "transaction", "submit", "error occurred", emojis in UI, ALL-CAPS sentences (tiny badges like PRO · LIVE · SOON are fine).
7. **Sentence case everywhere.** Including titles and buttons.
8. **Reassure with specifics.** "Released if Lukas declines" beats "fully refundable".
